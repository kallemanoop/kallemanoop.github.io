...
Led events such as **ACM Career Compass**, **Parichay**, **Introduction to LLMs**, **Decoding Emotions - NLP Workshop** and **Xplore IOT**
...
**MLOps:** MLflow, Docker, DVC / DagsHub, AWS (S3, EC2, SageMaker)  
**Pipelines:** Airflow, SQLite, PostgreSQL  
**APIs:** Flask, FastAPI, Streamlit